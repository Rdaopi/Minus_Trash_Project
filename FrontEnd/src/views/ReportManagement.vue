<template>
    ...
    <!-- Pagina di accesso negato per utenti non autorizzati -->
    <div v-else class="unauthorized">
      <div class="unauthorized-content">
        ...
        <div class="current-role" v-if="currentUserRole">
          <p>Il tuo ruolo attuale: <strong>{{ formatUserRole(currentUserRole) }}</strong></p>
        </div>
        <div class="help-text">
          <p>Se ritieni di dover avere accesso a questa sezione, contatta l'amministratore del sistema.</p>
        </div>
  ...
  const formatUserRole = (role) => {
    ...
    return roleLabels[role] || role || 'Non definito';
  };
  ...
  function handleChangeStatus(report) {
